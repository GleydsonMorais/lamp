			...
			<div class="container">
				...
				<div id="navbar" class="navbar-collapse collapse">
					...
					<ul class="nav navbar-nav">
						...
						<li><a href="paraValidar.php">Para Validados</a></li>
						<li><a href="validados.php?valorPesquisa=<?='validados';?>">Validados</a></li>
						<li><a href="naoValidados.php?valorPesquisa=<?='naoValidados';?>">Não Validados</a></li>
					</ul>
